...
def joystick_data_new():
    ...
    if "a" in data:
        # joystick_data_1.update(data["a"])
        process_joy1_new_buggy_left_right_data(data["a"])
    if "b" in data:
...
def send_rc_values(throttle_data, yaw_data, pitch_data, roll_data, slider_1, slider_2, toggle_1, toggle_2, joystick_type):
