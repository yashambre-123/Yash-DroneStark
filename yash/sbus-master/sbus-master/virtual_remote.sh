...
# Start a detached screen session named "Sender" and run a Python3 script
screen -dmS Sender bash -c "python3 /home/vision/sbus/app.py; exec bash"

# Print a message indicating the start of the Receiver Script
echo "Started Receiver Script"

# Start a detached screen session named "Receiver" and run a Python3 script
screen -dmS Receiver bash -c "python3 /home/vision/sbus/ext_receive.py; exec bash"

# Print a message indicating the start of the Physical Remote Receiver Script
echo "Started Physical Remote Receiver Script"

# Start a detached screen session named "Physical_Receiver" and run a Python3 script
screen -dmS Physical_Receiver bash -c "python3 /home/vision/sbus/receive.py; exec bash"
