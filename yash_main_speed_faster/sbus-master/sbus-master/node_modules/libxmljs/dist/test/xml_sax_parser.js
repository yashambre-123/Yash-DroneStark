...
function createParser(parser, callbacks) {
...
module.exports.sax = function (assert) {
    ...
    var parser = createParser(index_1.SaxParser, callbacks);
...
module.exports.sax_push_chunked = function (assert) {
    ...
    var parser = createParser(index_1.SaxPushParser, callbacks);
...
//# sourceMappingURL=xml_sax_parser.js.map